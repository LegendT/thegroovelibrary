...
export default {
  ...
  getMixcloudEmbedUrl(key) {
    ...
    // Use player-widget.mixcloud.com (the actual widget domain after redirect)
    return `https://player-widget.mixcloud.com/?hide_cover=1&feed=${encodeURIComponent('/' + cleanKey)}`;
  },
